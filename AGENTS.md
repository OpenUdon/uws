...
1. `versions/1.5.0.json` — the latest canonical JSON Schema for UWS 1.x documents. `versions/1.0.0.json`, `versions/1.1.0.json`, `versions/1.1.1.json`, `versions/1.2.0.json`, `versions/1.3.0.json`, and `versions/1.4.0.json` remain published historical schemas. `versions/browser.1.5.json` publishes the browser capability profile sub-spec referenced by `sourceDescriptions[].type: browser-profile`.
2. `uws1/` — the Go model and semantic validator.
3. `versions/1.5.0.md` — the latest human-readable spec. `versions/1.0.0.md`, `versions/1.1.0.md`, `versions/1.1.1.md`, `versions/1.2.0.md`, `versions/1.3.0.md`, `versions/1.4.0.md`, `versions/arazzo.md`, `versions/article.md`, and `ideas/terraform.md` are comparison/background docs. `versions/browser.1.5.md` is the browser capability profile sub-spec.
