...
func TestPathForBrowserSourceProfileFindsReadableSchema(t *testing.T) {
	for _, profile := range []string{"", "1.5", "1.5.json", "browser.1.5", "browser.1.5.json", "uws.browser.1.5", "uws.browser.1.5.json", "1.6", "uws.browser.1.6", "1.7", "uws.browser.1.7", "1.8", "uws.browser.1.8"} {
...
func TestEmbeddedSchemaPathFindsReadableSchema(t *testing.T) {
	for _, name := range []string{"1.0.0.json", "1.1.0.json", "1.1.1.json", "1.2.0.json", "1.3.0.json", "1.4.0.json", "1.5.0.json", "1.6.0.json", "1.7.0.json", "1.8.0.json", "1.9.0.json", "1.9.1.json", "1.9.2.json", "1.10.0.json", "runtime.1.0.json", "browser.1.5.json", "browser.1.6.json", "browser.1.7.json", "browser.1.8.json", "browser-authentication.1.0.json", "browser-authentication.1.1.json", "browser-authentication-call.1.0.json", "browser-authentication-call.1.1.json"} {
