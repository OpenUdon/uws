...
func TestEmbeddedSchemaPathFindsReadableSchema(t *testing.T) {
	for _, name := range []string{"1.0.0.json", "1.1.0.json", "1.1.1.json", "1.2.0.json", "1.3.0.json", "1.4.0.json", "1.5.0.json", "1.6.0.json", "1.7.0.json", "1.8.0.json", "1.9.0.json", "1.9.1.json", "1.9.2.json", "runtime.1.0.json", "browser.1.5.json", "browser.1.6.json", "browser.1.7.json", "browser-authentication.1.0.json", "browser-authentication.1.1.json", "browser-authentication-call.1.0.json", "browser-authentication-call.1.1.json"} {
