...
| Item | State | Notes |
|---|---|---|
| Specify and verify non-`await` wait | `[ ]` | Define bounded numeric seconds, orchestration responsibility, step/workflow/operation timing, errors and cancellation; test compatibility under C02 before changing execution. Owners: A3/C5. |
