...
| Correct stale published supplement wording | `[ ]` | Make editorial-only browser 1.7 and Runtime Supplement corrections; do not change schema or semantics; correct invalidated current-memory facts in this commit. |
