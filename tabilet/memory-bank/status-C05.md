...
| Document compatibility exception and verify distribution | `[ ]` | Owns F09. Update the mutable changelog and validation guide for the all-version admission fix; run direct/file compatibility and full acceptance checks, then the whole-milestone review. C04 later incorporates the rule in its new spec without reopening frozen history. |
