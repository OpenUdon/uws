...
Outcome: `completed`
Retired: `2026-09-24`
Source status: `tabilet/memory-bank/status-C04.md`
Source specification: `tabilet/memory-bank/status-C04.md#status-c04---uws-111-contract-repair`
Evidence: `109d3983cfdbdc42c46ccf612af0a44d615a5cf4`
Worktree: `includes uncommitted changes`
Review: `passed`
Review iterations: `2`
Verification: `go test ./... -count=1`; `go test -race ./...`; `go vet ./...`; `mkdocs build --strict`; `git diff --check`; focused UWS 1.11 grammar/analyzer and conformance tests
Consolidated into: [UWS 1.11 specification](../../../versions/1.11.0.md), [current product facts](../../memory-bank/product.md), and [versioned-release lesson](../../memory-bank/lessons.md)
...
published during C04 execution; all five task rows, the final
guide/release-surface row, and the milestone acceptance review are complete.
...
JSON-number literals for non-`await` `wait` and `batchSize`, with version-aware
