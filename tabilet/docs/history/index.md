...
Knowledge updates that replace current facts or lessons are recorded in
[knowledge.md](knowledge.md).

| Milestone | Outcome | Retired | Record | Summary |
|---|---|---|---|---|
| M01 | completed | 2026-09-23 | [status-M01.md](status-M01.md) | Current release documentation coherently surfaces registration 1.2 and historical supplement context. |
| M02 | completed | 2026-09-23 | [status-M02.md](status-M02.md) | Published non-changelog Markdown artifacts now have exact membership and SHA-256 protection. |
