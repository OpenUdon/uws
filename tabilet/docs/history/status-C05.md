...
Outcome: `completed`
Retired: `2026-09-23`
Source status: `tabilet/memory-bank/status-C05.md`
Source specification: `tabilet/memory-bank/status-C05.md#status-c05---exact-version-admission`
Evidence: `fea3a6c06024d944adad5d11c84cb0bb603b58ad`
...
1.11 release work. This milestone is implemented and accepted.
...
**Downstream impact.** Pending [C04](status-C04.md) now carries the
admitted-version rule and cross-version exception into UWS 1.11's normative
policy and release notes. C05 completed before Browser 1.9 work.
...
**Review gate.** Iteration 1 of 10 started 2026-09-23. Deep-review both C05
task commits and the complete status specification for version admission,
SemVer diagnostics, custom exact-schema behavior, supported-version
compatibility, test coverage, and changelog/guide consistency. Review passed
on iteration 1 of 10 on 2026-09-23: no P1, P2, or higher finding remains.
The shared `Document.executeEntry` prologue applies semantic admission to
document, workflow, step, operation, and trigger-dispatch execution entry
points; schema artifact parity and the custom exact-schema rejection are
covered. Task and full acceptance checks passed; no review fix was required.
````
