...
func (op *Operation) validate(path string, idx *documentIndex, result *ValidationResult) {
	...
	case op.HasSourceBinding():
		if !hasSource {
			...
			case SourceDescriptionTypeGoogleDiscovery, SourceDescriptionTypeAWSSmithy, SourceDescriptionTypeAsyncAPI, SourceDescriptionTypeGraphQL, SourceDescriptionTypeOpenRPC, SourceDescriptionTypeGRPCProtobuf, SourceDescriptionTypeOData, SourceDescriptionTypeBrowserProfile, SourceDescriptionTypeAnsibleModule:
